...
namespace BlazorECommerce.Server.Services.PaymentService
{
    public class PaymentService : IPaymentService
    {
        ...
        const string secret = "whsec_3f931cef77eb75e871308af5cd9b882c8735c1a52ccdcd9cb8a0bff1b70fb8ea";

        public PaymentService(ICartService cartService, IOrderService orderService, IAuthService authService)
        {
            StripeConfiguration.ApiKey = "sk_test_51Ki3FvHGn3MKnrJu1YiSS7AatJLU7mJG7w7DBIjY9gkSP40bq8F7old9jeugAiwPEOBgAx2GcI5fm3mxy2LvnSUe00WcwomXY7";
        ...
        public async Task<Session> CreateCheckoutSessionAsync()
        {
            ...
            var options = new SessionCreateOptions
            {
                ...
                LineItems = lineItems,
                Mode = "payment",
                SuccessUrl = "https://localhost:7108/order-success",
                CancelUrl = "https://localhost:7108/cart"
            };
